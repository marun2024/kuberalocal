...
export default function VendorDashboard() {
  ...
  const navigateToVendor = (vendorId: string) => {
    ...
    // Future: Navigate to vendor-specific view
          ...
          <div className="flex h-16 justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-700 dark:text-gray-300">
                {user?.first_name} {user?.last_name} • {user?.tenant_name}
              </span>
              <button
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Browse and manage your vendor relationships
            </p>
              ...
              {vendors.map((vendor) => (
                <div
                  ...
                  className={`bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg hover:shadow-lg transition-shadow cursor-pointer ${
                    selectedVendor === vendor.id ? 'ring-2 ring-blue-500' : ''
                  }`}
