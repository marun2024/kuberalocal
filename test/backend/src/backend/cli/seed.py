...
from backend.contracts.schemas import ContractCreate
from backend.contracts.models import Tag
from backend.contracts.schemas import TagCreate
import uuid
import random
...
async def create_demo_data(subdomain: str, include_contracts: bool = False, include_tags: bool = False):
